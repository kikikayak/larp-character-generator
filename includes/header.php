<?php
	...
	/**************************************************************
	NAME: 	header.php
	NOTES: 	Header for pages in main authenticated area.
	**************************************************************/
...
<link rel="stylesheet/less" type="text/css" href="../theme/<?php echo $_SESSION['theme']; ?>/main.less" />

<?php 
	if (isset($styleLink)) {
		echo '<link rel="stylesheet/less" type="text/css" href="../theme/' . $_SESSION['theme'] . '/' . $styleLink . '" />'; // Include custom stylesheet for this page, if there is one. 
	}
?>
